...
<body>
	...
	%>
		...
		//console.log("myArray[1].title : "+myArray[1].title);
		//console.log("myArray[1].latlng : "+myArray[1].latlng);
		//console.log("myArray[2].title : "+myArray[2].title);
		//console.log("myArray[2].latlng : "+myArray[2].latlng);
		//console.log("myArray[3].title : "+myArray[3].title);
		//console.log("myArray[3].latlng : "+myArray[3].latlng);
