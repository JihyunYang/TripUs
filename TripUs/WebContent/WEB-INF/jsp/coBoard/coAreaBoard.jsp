		...
		var contentid=${contentid};
				...
				$.ajax({
					...
					success : function(data) {
						...
						var output='';
							output += '<h2 style="font-size:40px; font-family: 나눔고딕">'  + '코스' + '</h2>';
							output += '<hr>';
							output += '<h3>' + myItem.subname + '</h3>';
							output += '<br>';
							output += '<hr>';
							output += '<div class="row" id="resInfo">';
							output += '<div class="col-md-7">';
							output += '<p class="">' + myItem.subdetailoverview + '</p>';
							output += '</div>';
							output += '<div class="col-md-5">';
							output += '<img class="img-rounded" width="400px" height="400px" src="' + myItem.subdetailimg  + '"alt="대표이미지">';
							output += '</div>';
							output += '</div>';
