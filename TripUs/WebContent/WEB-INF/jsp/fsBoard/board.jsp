		...
		var contentid=${contentid};
				...
				$.ajax({
					...
					success : function(data) {
						...
						var output='';
							output += '<h2 style="font-size:40px; font-family: 나눔고딕">'  + '축제' + '</h2>';
							output += '<hr>';
							output += '<h3>' + myItem.title + '</h3>';
							output += '<br>';
				...
				<div class="panel-group" id="accordion">
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a 
									href="/fsBoard/fsAreaSub.do?areaCode=6"> 부산</a>
							</h4>
						</div>
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a 
									href="/fsBoard/fsAreaSub.do?areaCode=4"> 대구</a>
							</h4>
						</div>
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a 
									href="/fsBoard/fsAreaSub.do?areaCode=3">대전</a>
							</h4>
						</div>
					</div>
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a 
									href="/fsBoard/fsAreaSub.do?areaCode=5">광주</a>
							</h4>
						</div>
					</div>
