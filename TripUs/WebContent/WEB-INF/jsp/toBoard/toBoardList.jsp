...
<head>
	...
	<style type="text/css">
    	...
    	#thumnailTitleHr {
    		...
    		width: 854px;
    		margin: 40px 0px -32px 44px;
    	}
    	
    	#thumnailTitleDiv {
    		margin : 53px 0px 10px 5%;
    	}
    	...
    	.thumListSpan {
    		...
    		display: block; 
    		color: #FFF; 
    		background: rgba(151 141 141 / 44%);
    		width : 179px; 
...
<body>
   ...
   <br>
	...
	<div class="container">
		...
		<div class="col-md-10">
			<div id="pageContent">
				<div id="carousel-example-generic" class="carousel slide" data-ride="carousel"  data-interval="3000" style="margin: 3.5% 0px 0px 8.4%;">
  					<!-- Indicators -->
					  ...
					  <div class="carousel-inner" role="listbox">
					    <div class="item active">
					      <a href="/toBoard/toBoardDetail.to?contentid=126508">
					      	<img src="https://cdn.visitkorea.or.kr/img/call?cmd=VIEW&id=3d2115be-4ed9-41bf-b98a-2ae7bf61c855" alt="image error" style="width: 860px; height:400px;">
					       </a> 
					    ...
					    <div class="item">
					      <a href="/toBoard/toBoardDetail.to?contentid=1030763">
					    	<img src="https://cdn.visitkorea.or.kr/img/call?cmd=VIEW&id=c60ce0e3-da23-42db-8a0c-8195a3e9f7d8" alt="image error" style="width: 860px; height:400px">
					      	</a>	
					      		<div class="carousel-caption">
					      		</div>
					    </div>
					    ...
					    <div class="item">
					    	<a href="/toBoard/toBoardDetail.to?contentid=2003909">
					    	<img src="https://cdn.visitkorea.or.kr/img/call?cmd=VIEW&id=6a6ede08-657e-42b8-a18a-6dcb74d225cf" alt="image error" style="width: 860px; height:400px">
					      		</a>
					      		<div class="carousel-caption">
					      		</div>
					    </div>
		...
		<!--thumImgList Section Start-->
	    <!--thumImgTitle Section-->
	    <div class="col-md-10" id="thumnailTitle">
			<hr id="thumnailTitleHr">
				<div id="thumnailTitleDiv">
					<h3 class="tit_atc"></h3> &nbsp;&nbsp;&nbsp; <span id="titAtcSpan">hot한 서울 야경 명소!</span>
     					<span id="titAtcSpan2">몸과 눈이 지친 현대인의 힐링 장소를 소개합니다.</span>	
				</div>	
		</div>
		<!--End of thumnailTitle div block -->
		
		<!--thumImgList Section-->
		<div>
			<ul class="thumListUl">
				<li>
					<a href="/toBoard/toBoardDetail.to?contentid=1874105">
						<img class="thumListImg" src="https://cdn.visitkorea.or.kr/img/call?cmd=VIEW&id=cc127946-ff83-45ac-a542-2e00eecea671" alt="응봉산 공원" onerror="this.src='/img/ResAreaOnerror.png'">
						<span class="thumListSpan">응봉산 공원</span>
					</a>
				</li>
					
				<li>
					<a href="/toBoard/toBoardDetail.to?contentid=2495561">
						<img class="thumListImg" src="https://cdn.visitkorea.or.kr/img/call?cmd=VIEW&id=77eb8509-55ff-4592-be20-9a9ce6ab8bbf" alt="서울로7017"  onerror="this.src='/img/ResAreaOnerror.png'">
						<span class="thumListSpan">서울로7017</span>
					</a>
				</li>
				
				<li>
					<a href="/toBoard/toBoardDetail.to?contentid=250131">
						<img class="thumListImg" src="https://cdn.visitkorea.or.kr/img/call?cmd=VIEW&id=8e042301-691b-4e23-9bbb-dd70591b6555" alt="올림픽대교" onerror="this.src='/img/ResAreaOnerror.png'">
						<span class="thumListSpan">올림픽대교</span>
					</a>
				</li>
				
				<li>
					<a href="/toBoard/toBoardDetail.to?contentid=729167">
						<img class="thumListImg" src="https://cdn.visitkorea.or.kr/img/call?cmd=VIEW&id=29017a91-ad62-47c2-8300-b6ef86397052" alt="반포대교" onerror="this.src='/img/ResAreaOnerror.png'">
						<span class="thumListSpan">반포대교</span>
					</a>
				</li>
			</ul>
				
			<ul class="thumListUl2">
				<li>
					<a href="/toBoard/toBoardDetail.to?contentid=2661405">
						<img class="thumListImg" src="https://post-phinf.pstatic.net/MjAyMDA3MDZfMTYg/MDAxNTk0MDMwNjY2NDk0.X-PHXFfxhnOwVvhWinXoQNBFJN3Zw5--m50hLK21Azcg.DSJ5gVF4hBa3JyZ5RcwCpfwyvutXC7RV_apNkPq-9ZIg.JPEG/31.jpg?type=w1200" alt="선유도 공원" onerror="this.src='/img/ResAreaOnerror.png'">
						<span class="thumListSpan">선유도 공원</span>
					</a>
				</li>
				
				<li>
					<a href="/toBoard/toBoardDetail.to?contentid=129501">
						<img class="thumListImg" src="https://cdn.visitkorea.or.kr/img/call?cmd=VIEW&id=632647e7-dfcf-46f3-9114-ea4d877b276f&mode=custom&height=518" alt="낙산공원" onerror="this.src='/img/ResAreaOnerror.png'">
						<span class="thumListSpan">낙산공원</span>
					</a>
				</li>
					
				<li>
					<a href="/toBoard/toBoardDetail.to?contentid=126535">
						<img class="thumListImg" src="https://cdn.visitkorea.or.kr/img/call?cmd=VIEW&id=206ac91c-27f9-4ec7-9cb8-3539bc206c17" alt="남산서울타워" onerror="this.src='/img/ResAreaOnerror.png'">
						<span class="thumListSpan" >남산서울타워</span>
					</a>
				</li>
				
				<li id="thumListMoreLi">
					<a href="/toBoard/resAreaSub.do?areaCode=1&sigunguCode=99"> 더보기 </a>
				</li>
			</ul>
		</div>
		<!--End of thumImgList div block-->
	</div>	
	<!--End of container-->
