 ...
 */
@WebServlet("/CoPublicData3.do")
public class CoPublicData3 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CoPublicData3() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("CoPublicData3: contentId"+contentid);
		...
		System.out.println("CoPublicData3.do 진입");
