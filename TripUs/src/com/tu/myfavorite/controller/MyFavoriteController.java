...
public class MyFavoriteController {
	...
	@ResponseBody
	public ModelAndView insertmyfavorite(@ModelAttribute MyFavoriteVO param,int contentTypeId, int contentId,String title,String addr1,HttpServletRequest request){
		...
		if(contentTypeId==12){
			param.setMygrade("1");
			param.setMylink("/toBoard/goBoard.do?contentid="+contentId);
		}else if(contentTypeId==39){
			param.setMygrade("2");
			param.setMylink("/restaurant/goBoard.do?contentid="+contentId);
		}else if(contentTypeId==15){
			param.setMygrade("3");
			param.setMylink("/fsBoard/goBoard.do?contentid="+contentId);
		}else{
			param.setMygrade("0");
			param.setMylink("/restaurant/goBoard.do?contentid="+contentId);
		}
