...
public class MyPageController {
	...
	public ModelAndView memberInfo(@ModelAttribute MemberVO param,HttpServletRequest request){
	...
	public ModelAndView infoUpdate(@ModelAttribute MemberVO param,HttpServletRequest request){
	...
	public String memberInfoUpdate(@ModelAttribute MemberVO param,HttpServletRequest request){
		...
		param.setMno(mno);
		param.setMprofile("/resource/img/p1.jpg");
		System.out.println("mno : "+ param.getMno());
